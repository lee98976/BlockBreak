...
while True:
    ...
    for enemy in hits:
        ...
        # checks whether the enemy even has the isHarmful variable (to prevent crashes) then check whether the enemy is harmful in determining whether to deal damage.
